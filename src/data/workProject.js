const data = [
  ...
  },
  {
    ...
    name_en: 'Winter',
    image:
      'https://res.cloudinary.com/loxi/image/upload/v1639489627/assets/artworks/%E5%87%9C%E5%86%AC_resize_y8mues.jpg',
    image_webp: '',
    thumb:
      'https://res.cloudinary.com/loxi/image/upload/c_fill,h_400,w_400/v1639489627/assets/artworks/%E5%87%9C%E5%86%AC_resize_y8mues.jpg',
    tag: ['Digital', 'Graphic'],
    date: '2021',
    description_tw: '寒冷卻不令人討厭的冬天。在畏冷中期待冬日來到的矛盾心理。',
    description_en:
      'Cold, but not unpleasant winter. The ambivalence of fearing the cold, but looking forward to winter.',
    url: 'https://res.cloudinary.com/loxi/image/upload/v1639489627/assets/artworks/%E5%87%9C%E5%86%AC_resize_y8mues.jpg',
  },
  {
    id: 33,
    name_tw: '微晴',
    ...
    tag: ['Digital', 'Graphic'],
    date: '2021',
    description_tw: '新生活中各種艱難挑戰與機遇並存。前路雖迷濛，但望見天晴。',
    description_en:
      'The new life is full of challenges and opportunities. Although the road ahead is misty, hope can see the sun in the future.',
    url: 'https://res.cloudinary.com/loxi/image/upload/v1636380175/assets/artworks/%E5%BE%AE%E6%99%B4_resize_xudadg.jpg',
  },
  {
    id: 32,
    name_tw: '荒',
    ...
    url: 'https://res.cloudinary.com/loxi/image/upload/v1636176354/assets/artworks/%E8%8D%92_resize_gsvrph.jpg',
  },
  {
    id: 31,
    name_tw: '對影',
    ...
    url: 'https://res.cloudinary.com/loxi/image/upload/v1632234302/assets/artworks/%E5%B0%8D%E5%BD%B1_resize_gx0nxi.jpg',
  },
  {
    id: 30,
    name_tw: '深淵',
    ...
    url: 'https://res.cloudinary.com/loxi/image/upload/v1622268311/assets/artworks/%E6%B7%B1%E6%B7%B5_resize_fqjonw.jpg',
  },
  {
    id: 29,
    name_tw: 'Karma',
    ...
    url: 'https://res.cloudinary.com/loxi/image/upload/v1617346390/assets/artworks/karma_resize2_nslxz9.jpg',
  },
  {
    id: 28,
    name_tw: '虛空',
    ...
    url: 'https://res.cloudinary.com/loxi/image/upload/v1615954142/assets/artworks/void_resize_lvhta5.jpg',
  },
  {
    id: 27,
    name_tw: '台灣觀光景點查詢',
  ...
  },
  {
    ...
    url: 'https://res.cloudinary.com/loxi/image/upload/v1613490571/assets/artworks/%E8%BA%81_resize_lo5ilq.jpg',
  },
  {
    id: 24,
    name_tw: '亂心',
    ...
    url: 'https://res.cloudinary.com/loxi/image/upload/v1612106161/assets/artworks/%E4%BA%82%E5%BF%83_resize_grwmrz.jpg',
  },
  {
    id: 23,
    name_tw: '抽象絲綢',
  ...
  },
  {
    ...
    url: 'https://res.cloudinary.com/loxi/image/upload/v1609421942/assets/artworks/%E7%B6%BB%E5%85%89_resize_gedjin.jpg',
  },
  {
    id: 21,
    name_tw: '太古引',
  ...
  },
  {
    ...
    url: 'https://res.cloudinary.com/loxi/image/upload/v1609047654/assets/artworks/waterInk_abstract_01_y_vvxuev.jpg',
  },
  {
    id: 18,
    name_tw: '墨暈山水',
  ...
  },
  {
    ...
    url: 'https://res.cloudinary.com/loxi/image/upload/v1609047687/assets/artworks/waterInk_abstract_01_r_fpbpk1.jpg',
  },
  {
    id: 16,
    name_tw: '飄移墨跡',
  ...
  },
  {
    ...
    url: 'https://res.cloudinary.com/loxi/image/upload/v1609047672/assets/artworks/waterInk_abstract_02_b_byzpqc.jpg',
  },
  {
    id: 14,
    name_tw: '春日茶宴',
    ...
    url: 'https://res.cloudinary.com/loxi/image/upload/v1609047658/assets/artworks/waterInk_abstract_02_g_migadj.jpg',
  },
  {
    id: 13,
    name_tw: 'LAVIDA',
  ...
  },
  {
    ...
    description_en:
      'The main body is the call APP provided to the customer service of the lending platform. Originally, PM proposed to refactor with nuxt, but the proposal was abandoned for various reasons after completing the client data API trial connection. The remaining part of the source code can be viewed on github.',
  ...
  },
  {
    ...
    description_en:
      'As a design and programming exercise, a gallery-style portfolio website made for my calligraphy teacher. Contains homepage slide, RWD Nav and art display effects. In order to confirm the SEO effect, use nuxt of the vue ecosystem to generate static SPA pages.',
  ...
  },
  {
    ...
    date: '2018',
    description_tw:
      '為了配合防疫工作，提供給防檢局的非洲豬瘟資訊網頁。負責產出全網站需要的UI ,包含首頁形象設計、客製icon、新聞內頁和資料列表的樣式。',
    description_en:
      'In order to cooperate with the epidemic prevention work, the African swine fever information webpage provided to the Bureau of Prevention and Inspection. Responsible for producing the UI required by the entire website, including the homepage image design, custom icon, news page and information list styles.',
  ...
  },
  {
    ...
    date: '2018',
    description_tw:
      '農委會英文版官網的新版。整體架構由一間外包公司製作，我負責的部分則為首頁內容、專有名詞對照表、活動圖列表等複數內頁的UI。',
    description_en:
      'A new version of the English version of the official website of the Council of Agriculture. The overall structure is produced by an outsourcing company, and the part I am responsible for is the UI of multiple internal pages such as the homepage content, proper noun comparison table, and activity diagram list.',
  ...
  },
  {
    ...
    date: '2017',
    description_tw:
      '農委會青年農民輔導網站的新版。負責規劃全網站的UI、PSD切版，以及首頁動畫的製作。',
    description_en:
      'The new version of the Youth Farmer Guidance Website of the Council of Agriculture. Responsible for planning the UI, PSD cut version of the whole website, and the production of homepage animation.',
  ...
  },
  {
    ...
    date: '2017',
    description_tw:
      '農委會提供給學校午餐供應商的QA列表。主要是關於食材的3b1q(舊為4b1q)規定。',
    description_en:
      'The QA list provided by the Council of Agriculture to school lunch suppliers. It is mainly about 3b1q (formerly 4b1q) regulations on food ingredients.',
  ...
  },
  {
    ...
    date: '2015~2017',
    description_tw:
      '包含幾年前曾創作的一些平面廣告、書籍、UI設計等統合在內的作品集。',
    description_en:
      'A collection of works including some print advertisements, books, UI designs, etc. created a few years ago.',
    url: 'https://issuu.com/loxi/docs/loxi_portfolio2',
  },
];
